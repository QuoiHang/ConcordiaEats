...
### The final version is on main branch in [Menayang's repo](https://github.com/mengyangq/ConcordiaEats). Kindly ask for access since the final project works on Cloud database instead of local server.
