	...
	<body>
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			<div class="container-fluid">
				<a class="navbar-brand" href="#"> <img th:src="@{/images/logo.png}" src="../static/images/logo.png"
				...
				<div class="row">
					<div class="col-sm-5">
						<% try { String url="jdbc:mysql://localhost:3306/springproject" ;
							...
							con=DriverManager.getConnection(url, "root" , "" ); Statement stmt=con.createStatement();
							ResultSet rs=stmt.executeQuery("select * from products order by id desc"); %>
							<div class="form-group">
								<% if (rs.next()) { %>
									<label for="name">Id</label>
									<input type="number" readonly="readonly" class="form-control border border-warning"
							...
							<div class="form-group">
								...
								<select class="form-control border border-warning" name="categoryid" required>
									<% rs=stmt.executeQuery("select * from categories"); while(rs.next()) { %>
										<option>
											<%= rs.getString(2) %>
										</option>
										<% } %>
					...
					<div class=" form-group">
								...
								<input type="number" class="form-control border border-warning" required name="price"
