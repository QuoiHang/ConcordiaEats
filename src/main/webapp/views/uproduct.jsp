						...
						<tbody>
							<tr>
								...
								<% try { String url="jdbc:mysql://localhost:3306/springproject" ;
									...
									con=DriverManager.getConnection(url, "root" , "" ); Statement
									stmt=con.createStatement(); Statement stmt2=con.createStatement(); ResultSet
									...
									<% while (rs.next()) { %>
										...
										<td>
											<% int categoryid=rs.getInt(4); ResultSet rs2=stmt2.executeQuery("select *
												from categories where categoryid="+categoryid+" ;"); if(rs2.next()) {
